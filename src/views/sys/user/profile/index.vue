          ...
          <div>
            ...
            <ul class="list-group list-group-striped">
              <li class="list-group-item">
                ...
                <span class="margin-left-4">User name</span>
                <div class="pull-right">{{ user.userCode }}</div>
              </li>
              <li class="list-group-item">
                <svg-icon icon-class="phone"/>
                <span class="margin-left-4">Phone number</span>
                <div class="pull-right">{{ user.mobile }}</div>
              </li>
              <li class="list-group-item">
                <svg-icon icon-class="email"/>
                <span class="margin-left-4">User email</span>
                <div class="pull-right">{{ user.userEmail }}</div>
              </li>
              <li class="list-group-item">
                <svg-icon icon-class="tree"/>
                <span class="margin-left-4">Department</span>
                <div class="pull-right" v-if="user.dept">{{ user.dept.deptName }}</div>
              </li>
              <li class="list-group-item">
                <svg-icon icon-class="peoples"/>
                <span class="margin-left-4">Role</span>
                <div class="pull-right">{{ roleGroup }}</div>
              </li>
              <li class="list-group-item">
                <svg-icon icon-class="date"/>
                <span class="margin-left-4">Creation date</span>
